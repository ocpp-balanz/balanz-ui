...
const ResetCharger: React.FC<ResetChargerProp> = ({api, charger_id, charger_alias, snack}) => {
  ...
  return (<>
    ...
    <Dialog open={open}  onClose={handleClose}>
        ...
        <DialogContentText id="alert-dialog-description">
            Are you sure you want to reset the charger on {charger_alias} ({charger_id})?
            If so, choose between a Soft and a Hard reset. 
        </DialogContentText>
        </DialogContent>
        <DialogActions>
