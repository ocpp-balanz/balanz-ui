  ...
  return (<>
    ...
    <Dialog open={open}  onClose={handleClose}>
        ...
        <DialogContentText id="alert-dialog-description">
            Are you sure you want to remotely stop the charging session on {charger_alias} ({charger_id}) connector {connector_id}? 
        </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleClose}>No</Button>
          <Button onClick={remoteStop} autoFocus>Yes</Button>
        </DialogActions>
    </Dialog>
    </>
  );
